...
const PropertyListings = () => {
    ...
    const viewSellerDetails = async (propertyId) => {
        ...
        try {
            ...
            setSelectedSellerDetails(prev => ({ ...prev, [propertyId]: { name, contactNumber } }));
        } catch (error) {
                    ...
                    {filteredProperties.map((property) => (
                        <li key={property.id} className="property-card">
                            ...
                            <div className="property-box">
                                ...
                                <div className="property-field"><b>BuiltUp:</b> {property.builtup}</div>
                            ...
                            <div className="view-seller-details">
                                ...
                                {selectedSellerDetails[property.id] && (
                                    <div className="seller-details">
                                        <p><b>Seller Name:</b> {selectedSellerDetails[property.id].name} <b>Phone Number: </b> {selectedSellerDetails[property.id].contactNumber}</p>
